...
# NOTE:
# Many modules in this codebase depend on in-process mutable state populated by
# jyotishyamitra (jm) and support.* (e.g. support.mod_astrodata, support.dashas).
# Therefore chart computation MUST run in-process, guarded by a lock to prevent
# concurrent requests from corrupting shared state.
